/*
  ...
  2. Purpose
    - Store email verification status during onboarding
    - Allow users to continue signup process after verification
    - Support resuming the signup flow if user drops off
*/
