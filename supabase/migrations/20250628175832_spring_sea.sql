...
-- Note: The cron scheduler has been removed as the cron schema doesn't exist
-- You can manually run the cleanup function or set up a separate scheduled task
