/*
  # Email Verification Cache Migration

  1. New Tables
    - `email_verification_cache` - Stores email verification status
  ...
  3. Functions
    - `cleanup_expired_email_verifications` - Removes expired verification records
*/
