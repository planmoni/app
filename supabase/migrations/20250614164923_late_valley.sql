/*
  ...
  1. Changes
    - Remove the status column from bank_accounts table
    - Update the process_payout function to not reference status
  
  2. Rationale
    - Bank accounts are intended for receiving payments and don't require verification
    - Simplifies the user experience by removing unnecessary status indicators
*/
