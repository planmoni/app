/*
  ...
  1. Database Functions
    - Create comprehensive wallet management functions
    - Add proper error handling and validation
    - Return detailed information for debugging
  
  2. Data Integrity
    - Ensure all wallets have proper default values
    - Add constraints to prevent negative balances
    - Ensure locked_balance never exceeds total balance
*/

-- First, check if the balance and locked_balance columns exist, and add them if they don't
DO $$
BEGIN
  ...
  -- Check if locked_balance column exists
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns 
