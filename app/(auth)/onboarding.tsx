...
import { Eye, EyeOff, Mail, Lock, User, Info, CreditCard, Fingerprint, ArrowLeft, ChevronDown, ChevronUp } from 'lucide-react-native';
          ...
          {currentStep === 'bvn' ? (
            ...
            <Button
              ...
              disabled={
                ...
                (currentStep === 'otp' && formData.otp.length !== 4) ||
