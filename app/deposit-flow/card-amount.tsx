...
export default function CardAmountScreen() {
          ...
          <View style={styles.infoSection}>
            <View style={styles.infoCard}>
              ...
              <Text style={styles.infoText}>
                Your card details are securely processed and not stored on our servers. We use industry-standard encryption to protect your information.
              </Text>
            </View>
          </View>
        </View>
